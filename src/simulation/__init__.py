...
- merchant_prototype: 商家原型（MerchantPrototype, MerchantPrototypeFactory, MerchantRegistry）
...
from .merchant_prototype import (
    ...
    build_merchant_registry_from_data,
)
...
__all__ = [
    ...
    # 商家原型
    "MerchantPrototype", "MerchantPrototypeFactory", "MerchantRegistry",
    "build_merchant_registry", "build_merchant_registry_from_data",
    # 社会网络传染
